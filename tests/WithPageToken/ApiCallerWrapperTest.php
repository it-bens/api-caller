...
namespace ITB\ApiCaller\WithPageToken\Tests;

use Generator;
use ITB\ApiCaller\Tests\WithPageToken\ApiCallerMock;
...
{
    protected const NO_ITEM_COUNT = 0;
    protected const WITH_ITEM_COUNT = 100;
    protected const MAX_RESULTS_PER_REQUEST = 5;
